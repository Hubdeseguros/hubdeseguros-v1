  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      <div>
        ...
        <input name="policy_id" value={form.policy_id} onChange={handleChange} className="input" required />
      </div>
      <div>
      ...
      <div>
        ...
        <input name="payment_date" type="date" value={form.payment_date} onChange={handleChange} className="input" required />
      </div>
      <div>
        <label className="block text-sm font-medium">Método</label>
        <input name="method" value={form.method} onChange={handleChange} className="input" required />
      </div>
      <div>
