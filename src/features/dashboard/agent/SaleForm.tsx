...
export const SaleForm: React.FC<Props> = ({ initialData, onSubmit, onCancel }) => {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <input name="poliza" value={form.poliza} onChange={handleChange} placeholder="Póliza" required className="input" />
      <input name="monto" type="number" value={form.monto} onChange={handleChange} placeholder="Monto" required className="input" />
